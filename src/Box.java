...
class Box extends JFrame{
	...
	private	JFileChooser filVäljare = new JFileChooser(".");
	...
	public Box(){
		...
		FileFilter bildFilter = new FileNameExtensionFilter("Bilder","jpg",
				"gif","png");
		filVäljare.setFileFilter(bildFilter);
	...
	class OpenPicture implements ActionListener{
		public void actionPerformed(ActionEvent ave){
			int answer = filVäljare.showOpenDialog(Box.this);
	...
	class SearchLyss implements ActionListener{
		public void actionPerformed(ActionEvent ave){
			...
			//Koppla sökfältet med inskrivna ordet, koppla sedan lyssnare till sökknappen
			//Hämta sedan ord från HashMap? if/else om null bildpanel.visaValdaORd
		}
	}
